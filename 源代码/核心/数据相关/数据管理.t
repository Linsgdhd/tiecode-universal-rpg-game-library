...
类 数据管理器
	...
	定义事件 错误(内容 : 文本)
	方法 取位图(资源名称 : 文本) : 位图对象
		// 调试输出("资源管理器 : " + 取目录路径(路径定义.图片路径) + 资源名称)
		如果 文件是否存在(取目录路径(路径定义.图片路径) + 资源名称) 则
			// 调试输出("资源管理器 : " + 取目录路径(路径定义.图片路径) + 资源名称 + " * ok")
			返回 位图对象.从文件路径创建位图(取目录路径(路径定义.图片路径) + 资源名称)
		否则
			调试输出("资源管理器 : " + 取目录路径(路径定义.图片路径) + 资源名称 + " * no")
			返回 生成器.错误位图("指定资源不存在!")
		结束 如果
	结束 方法
